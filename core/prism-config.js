/* ============================================================
   ...
   What lives here:
     ...
     goalStep       — once the goal is reached, show the next multiple
                      of this instead (0 = off, bar stays full)
...
window.PRISM_CONFIG = {
  ...
  iconStyle: "svg",
  socials: [
    { icon: "x.com",              name: "X",        alt: "X",     label: "@NeoTheFox98",  url: "https://x.com/NeoTheFox98" },
    { icon: "youtube.com",        name: "YouTube",  alt: "YT",    label: "/NeoTheFox-98", url: "https://www.youtube.com/@NeoTheFox-98" },
    { icon: "telegram.org",       name: "Telegram", alt: "TG",    label: "@NeoTheFox98",  url: "https://t.me/NeoTheFox98" },
    { icon: "steamcommunity.com", name: "Steam",    alt: "Steam", label: "/NeoTheFox98",  url: "https://steamcommunity.com/id/NeoTheFox98" }
  ]
};
